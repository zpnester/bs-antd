...
let make = () => {
    ...
    <>
        ...
        <Content 
        style={ReactDOMRe.Style.make(~padding="0 50px", ())}
        >
        <Breadcrumb 
        style={ReactDOMRe.Style.make(~margin="16px 0", ())}
        >
        ...
        <div 
            style={ReactDOMRe.Style.make(~background="#fff", ~padding="24px", ~minHeight="280px", ())}
        >{string("Content")}</div>
        </Content>
        <Footer 
