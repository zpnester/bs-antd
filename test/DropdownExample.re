...
let make =() => {
    ...
    let menu = <Menu>
        <Menu.Item>
           <a target="_blank" 
           rel="noopener noreferrer" href="#">{string("1st menu item")}</a>

        </Menu.Item>
        <Menu.Item>
            <a target="_blank"
            rel="noopener noreferrer" href="#">{string("2nd menu item")}</a>
        </Menu.Item>
        <Menu.Item>
        <a target="_blank"
        rel="noopener noreferrer" href="#">{string("3rd menu item")}</a>
        </Menu.Item>
    </Menu>;
