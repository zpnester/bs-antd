...
let make = () => {
    ...
    <>
        ...
        <button onClick={_ => {
            ...
            |> ignore;
        }}>{string("show error and destroy")}</button>
        ...
        <button onClick={_ =>  {
            ...
            Js.Global.setTimeout(() => {
                Modal.warning(Config.make(~content=string("Second"), ())) |> ignore;
            }, 1000)
            |> ignore;
            ...
            |> ignore;
        }}>{string("show 2 modals and destroy all")}</button>
