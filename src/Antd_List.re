...
module ColumnCount = {
    ...
    [@bs.inline] let _6 = 6;
    [@bs.inline] let _8 = 8;
    [@bs.inline] let _12 = 12;
    [@bs.inline] let _24 = 24;
}
...
//   style: ReactDOMRe.Style.t,
  ...
  // ***** END HTML *****
    ...
    [@bs.module "antd/lib/list/Item"] external make: component(makeProps) = "default";  // default - potential problem

    module Meta = {

            // default - potential problem
        [@react.component] [@bs.module "antd/lib/list/Item"] [@bs.scope "default"] external make: (
            ~avatar: element=?,
            ~className: string=?,
            ~children: element=?,
            ~description: element=?,
