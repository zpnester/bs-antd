...
type makeProps = {
  ...
  [@bs.optional]
  wrapperCol: Antd_Grid.Col.makeProps,
  [@bs.optional]
  labelCol: Antd_Grid.Col.makeProps,
  [@bs.optional]
  colon: bool,
  [@bs.optional]
  labelAlign: LabelAlign.t,
  // ***** END ANTD FORM
  [@bs.optional]
  children: React.element,
};

[@bs.module "antd/es/form"] external make: component(makeProps) = "default";

module Item = {
  [@react.component] [@bs.module "antd/es/form"] [@bs.scope "default"]
  external make:
    (
      ~colon: bool=?,
      ~extra: element=?,
