...
module Col = {
  ...
  [@bs.module "antd/es/grid/col"] external make: component(makeProps) = "default";
};
...
module Row = {
  module Justify = {
    ...
    let center = "center";
    [@bs.inline]
    let spaceAround = "space-around";
    [@bs.inline]
    let spaceBetween = "space-between";
  };
  ...
  [@bs.module "antd/es/grid/row"] external make: component(makeProps) = "default";
};